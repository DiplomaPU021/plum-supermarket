...
export default function DelNotification({
  setDeleteConfirm,
  productId,
  setError,
  ...props
  ...
  return (
    ...
    >
      <Modal.Body className={styles.modalbody}>
        ...
        <button className={styles.addbtn} onClick={deleteHandler}>
          Видалити
        </button>
        <button className={styles.addbtn2} onClick={() => props.onHide()}>
          Скасувати
        </button>
        <Form.Check type="radio" className={styles.radio} aria-label="radio 1">
          <Form.Check.Input
            type="radio"
