...
export default function Authorization({ logShow, regShow, congratsShow, userProfileShow, setLogShow, setRegShow, setCongratsShow, setAuthShow, setUserProfileShow, signOutHandler}) {
