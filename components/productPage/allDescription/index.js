          ...
          <Row className={styles.modal__body_card_rowDesc}>
            ...
            <Row>
              ...
              <span>
                ...
                швидше. Графічний — уп&apos;ятеро. А завдяки передовій системі
                Neural Engine швидкість машинного навчання зросла
                вдев&apos;ятеро. Новий MacBook Air працює без підзаряджання
                довше, ніж попередні моделі. І зовсім не шумить, тому що в нього
                немає вентилятора. Потужність ще ніколи не була такою
                компактною.
              </span>
            </Row>
            <Row>
